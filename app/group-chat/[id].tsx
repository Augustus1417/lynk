...
import { mockStudents, mockMessages, mockChats, currentUserId } from '@/data/mockData';
import { Message, Student, Chat } from '@/data/mockData';
...
export default function GroupChatScreen() {
  ...
  // Get group chat info
  const groupChat = mockChats.find(chat => chat.id === id);
  const participants = mockStudents.filter(student => 
    groupChat?.participants.includes(student.id)
  );
      ...
      <View style={[styles.header, { borderBottomColor: colors.border }]}>
        ...
        <View style={styles.headerInfo}>
          <View style={[styles.headerAvatar, { backgroundColor: colors.primary }]}>
            <Text style={[styles.headerAvatarText, { color: colors.secondary }]}>G</Text>
          </View>
          <View>
            ...
            <Text style={[styles.headerStatus, { color: colors.textSecondary }]}>
              {participants.length} members • {groupChat?.groupInfo?.section}
            </Text>
          </View>
        </View>
        <TouchableOpacity style={styles.infoButton}>
          <Text style={[styles.infoButtonText, { color: colors.primary }]}>ℹ</Text>
        </TouchableOpacity>
      </View>
